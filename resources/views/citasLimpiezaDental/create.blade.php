...
@section('content')
    <div class="container">
        ...
        <form action="{{url('/guardarCitaLimpieza')}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
           ...
           <center> <h5>Datos generales del dueño</h5> </center>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="datetime-local" name="start" id="fechaHoraCitaLimpieza" onchange="actualizarMensaje_al_crear_limpieza()" required>
