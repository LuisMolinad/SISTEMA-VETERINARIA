                        ...
                        <fieldset class="fieldset fieldset-no-linea">
                            ...
                            <div class="form-row" >
                                ...
                                <br>
                                    ...
                                    <textarea class="form-control" id="tratamientoAplicarRecetaMedica"  type="textarea" name="tratamientoAplicarRecetaMedica" rows="3" placeholder=" Escriba el tratamiento para el paciente"  required></textarea>
