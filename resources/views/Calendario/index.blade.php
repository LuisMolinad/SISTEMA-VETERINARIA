...
<div class="modal fade" id="eventoconsulta" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title">Datos Cita de Servicio</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
          </div>
...
<div class="modal fade" id="eventoeditar" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <form action="" id="editarServicio"> <!-- Se declara esta accion para poder capturar los datos del formulario -->
              ...
              <div class="form-group">
                <label for="tipoServicio_id">Servicio a Realizar</label>
                <select class="form-control" name="tipoServicio_id" id="tipoServicio_id" aria-describedby="helpId" placeholder="">
                  @foreach ($tipoServicios as $tipoServicio)
                  <option value="{{$tipoServicio->id}}">{{$tipoServicio->nombreServicio}}</option>
                @endforeach
                </select>  
