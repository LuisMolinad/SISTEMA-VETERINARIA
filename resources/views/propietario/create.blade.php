        ...
        <form action="{{url('/propietario')}}" method="POST" enctype="multipart/form-data">
            ...
            <legend class="legend">Propietario</legend>
                <div class="form-group">
                    ...
                    <input type="text" maxlength="30" class="form-control" id="nombrePropietario" name="nombrePropietario" placeholder="Ingrese el nombre del dueño de la mascota">
                </div>

                <div class="form-group">
                    <label for="telefonoPropietario">Número de teléfono</label>
                    <input type="tel" maxlength="8" class="form-control" id="telefonoPropietario" name="telefonoPropietario" placeholder="Ingrese el número de teléfono del dueño de la mascota">
                </div>
