    ...
    <div class="table-responsive-sm container-fluid contenedor">
        <div class="boton crear container_btn">
            @can('crear-propietario')
                <a href="/propietario/create"><button type="button" class="btn btn-success boton_crear">Crear
                        propietario</button></a>
            @endcan
        </div>
                    ...
                    <tr>
                        ...
                        <td id="botones-linea">
                            @can('editar-propietario')
                                <a href="{{ url('/propietario/' . $propietario->id . '/edit') }}"><button type="button"
                            ...
                            @can('borrar-propietario')
                                <form action="{{ url('/propietario/' . $propietario->id) }}" method="post">
                                    @csrf
                                    {{ method_field('DELETE') }}
                                    <button onclick="return confirm('Quieres borrar?')" type="submit"
                                        class="btn btn-danger">Eliminar</button>

                                </form>
                            @endcan

                            <a href="/mascota/create/{{ $propietario->id }}"><button type="button"
                                    class="btn btn-success">Crear mascota</button></a>
