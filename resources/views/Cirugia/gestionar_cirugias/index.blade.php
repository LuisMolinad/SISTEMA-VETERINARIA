                ...
                @foreach ($datos as $dato)
                    <tr>
                        ...
                        <td id="botones-linea">
                            ...
                            <a href="{{ url('/citacirugia/consultarCitaCirugia/' . $dato->id) }}"><button type="button"
                                    class="btn btn-info">Consultar</button></a>
                            <a href="{{ url('/citacirugia/editarCitaCirugia/' . $dato->id) }}"><button type="button"
