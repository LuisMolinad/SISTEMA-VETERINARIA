...
@section('librerias')
    ...
    <script src="{{ asset('js/fechaCirugia.js') }}"></script>
@endsection
...
@section('content')
    <div class="container">
        <form action="{{ url('/citacirugia') }}" method="POST" enctype="multipart/form-data" class="needs-validation"
            novalidate>
            @csrf
            <fieldset class="fieldset fieldset-no-linea">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputNombreMascota" name="nombre_mascota"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" id="ConceptoCirugia" name="conceptoCirugia" rows="3" maxlength="100"
                            onchange="actualizar_mensaje_al_crear()" placeholder="Motivo de la cirugía" required></textarea>
                    ...
                    <div class="form-group col-md-6">
                        <strong> <label for="RecomendacionesPre" style="color:black">Recomendaciones
                                preoperatorias</label></strong>
                        <textarea class="form-control" id="ecomendacionesPre" name="recomendacionPreoOperatoria" rows="3"
                            maxlength="100" placeholder="Recomendaciones a tomar en cuenta antes de la cirugía" required></textarea>
                ...
                <div class="form-group d-none">
                    <label for=""></label>
                    <input type="text" class="form-control" name="filtercirugias" id="filtercirugias"
                        aria-describedby="filtercirugias" value="citasCirugias">
                </div>

                @include('layouts.crear_recordatorio')

                <button type="submit" style="float: right; width: 100px; height: 50px;"
                    class="btn btn-success mb-2">Guardar</button>


                <a href="{{ url('/CirugiaPDF/' . $mascotas->id) }}" class="btn btn-primary btn-sm"
                    data-placement="left">{{ __('Acta de permiso') }} </a>
