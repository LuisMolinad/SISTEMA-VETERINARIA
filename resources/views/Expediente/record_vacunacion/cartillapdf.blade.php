    ...
    {{-- <center> <h4>CLINICA VETERINARIA PET'S PARADISE</h4> </center>
        <center> <h5>AUTORIZACIÓN PARA REALIZAR TRATAMIENTO, PROCEDIMIENTO, SEDACIÓN O CIRUGÍA</h5> </center> 
              <p align="justify"><br> 
                ...
                <br> --}}
                {{-- <h1>id:{{$especie_id}}</h1>
                <h1>idd:{{$especie_idd}}</h1> --}}
                {{-- <h1>id desde expediente:{{$expediente->mascota->especie_id}}</h1>
                <h1>nombre mascota desde expediente:{{$expediente->mascota->nombreMascota}}</h1>
                <h1>nombre dueño desde mascota desde expediente:{{$expediente->mascota->propietario->nombrePropietario}}</h1>
                <h1>id especie desde mascota desde expediente:{{$expediente->mascota->especie_id}}</h1>
                <h1>nombre especie desde mascota desde expediente:{{$expediente->mascota->especie->nombreEspecie}}</h1>
                <p>{{$rabia}}</p>
                <p>{{$parvovirus}}</p>
                <p>{{$parasitos}}</p>
                <p>{{$moquillo}}</p>
