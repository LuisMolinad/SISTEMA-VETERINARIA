$(document).ready(function(){
    ...
    $('#fechaHoraCitaLimpieza')[0].valueAsNumber = 6e4 * (Math.floor(Date.now() / 6e4) - new Date().getTimezoneOffset());
    $('#fechaHoraCitaLimpieza').change(function() {
     
        //atrapo el valor de fecha de cirugia
        var datetimeval = $('#fechaHoraCitaLimpieza').val(); /* .getUTCDay(); */
