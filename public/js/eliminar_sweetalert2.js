...
function alerta_eliminar_tiposervicio(nombre, id) {
    ...
    Swal.fire({
        title:
            "¿Está seguro que desea eliminar el tipo de servicio " +
            nombre +
            "?",
        text: "¡No podra revertir esta decision!",
        icon: "warning",
                ...
                .then((itemArray) => {
                    if (itemArray.length == 1) {
                        Swal.fire(
                            ...
                            "Existe una cita creada del tipo de servicio " +
                                nombre,
                            "error"
                        );
                        ...
                        Swal.fire(
                            ...
                            "Existen " +
                                itemArray.length +
                                " citas creadas del tipo de servicio " +
                                nombre,
                            "error"
                        );
                    } else {
...
function alerta_eliminar_citaVacuna(nombreVacuna, id, nombreMascota) {
    ...
    Swal.fire({
        title:
            "Esta seguro que desea eliminar la cita de vacunación de  <strong>" +
            nombreVacuna +
            "</strong> para  <strong>" +
            nombreMascota +
            "</strong>?",
        ...
        if (result.isConfirmed) {
            Swal.fire(
                "Se eliminara!",
                "El registro de la cita de vacuna para " +
                    nombreVacuna +
                    " sera eliminado.",
                "success"
            ).then((result) => {
...
function alerta_deshabilitar_tiposervicio(nombre, id) {
    ...
    Swal.fire({
        title:
            "¿Está seguro que desea deshabilitar el servicio " + nombre + "?",
...
function alerta_eliminar_cirugia(nombre, id) {
    ...
    Swal.fire({
        title:
            "¿Está seguro que desea eliminar la cita de cirugía de:  " +
            nombre +
            "?",
        ...
        if (result.isConfirmed) {
            Swal.fire(
                "¡Se eliminará!",
                "El registro de la cita de cirugía para " +
                    nombre +
                    " será eliminada.",
                "success"
            ).then((result) => {
...
function alerta_eliminar_usuario(id, name) {
    ...
    Swal.fire({
        title:
            "¿Esta seguro que desea eliminar al usuario <strong>" +
            name +
            " </strong>?",
        text: "No podra revertir esta decision!",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Swal.fire(
                "¡Se eliminará!",
                "El registro del usuario <strong>" +
                    name +
                    " </strong> se eliminará",
                "success"
            ).then((result) => {
...
function alerta_eliminar_role(id, name) {
    ...
    Swal.fire({
        title:
            "¿Esta seguro que desea eliminar el rol <strong>" +
            name +
            " </strong>?",
